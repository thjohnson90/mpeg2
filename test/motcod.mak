...
CPP_DEPS3 = ../src/parsers/motvecs.cpp ../src/parsers/block.cpp ../src/picture/picdata.cpp
...
$(TARGET): $(HDR_DEPS) $(CPP_DEPS) motcod.cpp
	   g++ -DTEST $(INCLUDE) -g -o $@ $(CPP_DEPS) motcod.cpp -lpthread
