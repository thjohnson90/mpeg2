...
HDR_DEPS3 = ../src/parsers/motvecs.h ../src/parsers/block.h ../src/picture/picdata.h
...
$(TARGET): $(HDR_DEPS) $(CPP_DEPS) mbinc.cpp
	   g++ -DTEST $(INCLUDE) -g -o $@ $(CPP_DEPS) mbinc.cpp -lpthread
