...
HDR_DEPS2 = ../src/thread/doorbell.h ../src/thread/thread.h ../src/stream/stream.h ../src/video/videoproc.h
CPP_DEPS1 = ../src/parsers/block.cpp ../src/bitbuffer/buf_bitbuf.cpp ../src/bitbuffer/bitbuf.cpp
CPP_DEPS2 = ../src/thread/doorbell.cpp ../src/thread/thread.cpp ../src/stream/stream.cpp ../src/video/videoproc.cpp
...
$(TARGET): $(HDR_DEPS) $(CPP_DEPS) qscal.cpp
	   g++ -DTEST $(INCLUDE) -g -o $@ $(CPP_DEPS) qscal.cpp -lpthread
